...
[SpatiaLite](https://www.gaia-gis.it/fossil/libspatialite/index){rel="noopener noreferrer" target="_blank"} is an extension to the lightweight SQLight database structure to allow for geospatial capabilities.

### SpatiaLite on Windows

SpatiaLite is nativly a linux tool, but there are community ports for Windows. We will be using the one provided by DB Browser, and installing it in conjunction with it. Please read our guide on DB Browser and finish that before starting this process.
