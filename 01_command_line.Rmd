...
lsw_1 = "./img/win_lsw_1.jpg"
lsw_2 = "./img/win_lsw_2.jpg"
lsw_3 = "./img/win_lsw_3.jpg"
lsw_4 = "./img/win_lsw_4.jpg"
lsw_5 = "./img/win_lsw_5.jpg"
lsw_6 = "./img/data lab command line.jpg"
```
...
![](`r lsw_1` "Windows search menu selecting Turn windows features on or off")
...
![](`r lsw_2` "Windows features window turning on Windows Subsystem for Linux")

You will not need to restart your computer. Once you have rebooted, open the Windows Store from the start menu.

![](`r lsw_3` "Windows search menu opening the Microsoft store")
...
![](`r lsw_4` "Home page of Microsoft store searching for Ubuntu")
...
![](`r lsw_5` "Windows search menu opening Ubuntu")

If a terminal window opens, you should be good to go!

![](`r lsw_6` "Ubuntu command line showing DataLab ascii art")
