...
```{r include=FALSE}
# anaconda images
anaconda_1 = "./img/mac_anaconda_1.png"
...
mac_anaconda_2 = "./img/mac_anaconda_2.png"
mac_anaconda_3 = "./img/mac_anaconda_3.png"
mac_anaconda_4 = "./img/mac_anaconda_4.png"
mac_anaconda_5 = "./img/mac_anaconda_5.png"
mac_anaconda_6 = "./img/mac_anaconda_6.png"
mac_anaconda_7 = "./img/mac_anaconda_7.png"
...
To install [Anaconda](https://www.anaconda.com/#){rel="noopener noreferrer" target="_blank"} on windows, first navigate to their site, select products, then Anaconda Distribution.

![](`r anaconda_1` "Anaconda homepage selecting the Anaconda Distribution for download")
...
To install [Anaconda](https://www.anaconda.com/#){rel="noopener noreferrer" target="_blank"} on mac, first navigate to their site, select products, then Anaconda Distribution.

![](`r anaconda_1` "Anaconda homepage selecting the Anaconda Distribution for download")

Navigate to the green button and click "download."

![](`r mac_anaconda_2` "Anaconda download operating system selection")

Once the download has finished, run the executable. You will need to select "allow" to enable the download and allow Anaconda-Nagivator access to control Terminal. 

![](`r mac_anaconda_3` "Mac asking to allow download")

![](`r mac_anaconda_4` "Mac asking to allow installation")

Click "continue" through the installer steps and "agree" to the terms of the software license agreement when prompted. Click "ok" and "allow" to allow Anaconda permissions to access your files. 

![](`r mac_anaconda_5` "Mac Anaconda installer welcome")

![](`r mac_anaconda_6` "Mac Anaconda installer software licensing agreement")

![](`r mac_anaconda_7` "Mac Anaconda installer allow access to files")
